...
function finalStr = question_cloze(num, nameStr, questionStr, generalFeedbackStr1, generalFeedbackStr2,  hint1, fileStr1, fileStr2, fileStr3, fileStr4)
    finalStr = '';
    ...
    finalStr = strcat(finalStr, '\n      <text><![CDATA[<p>', generalFeedbackStr1, generalFeedbackStr2, '</p>]]></text>');
