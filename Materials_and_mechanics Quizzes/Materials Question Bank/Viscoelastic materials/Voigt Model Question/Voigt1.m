...
IDString=strcat('Voigt-1. Question ID #', ID);
...
plot(t,u3,'linewidth',3,'Color','blue');
plot(t1,u4,'linewidth',3,'Color','blue','Linestyle',':');
plot(t2,u5,'linewidth',3,'Color','blue');
...
image3= strcat('<p><img src="http://s30.postimg.org/boomspwpt/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image4= strcat('<p><img src="http://s30.postimg.org/6h85205i9/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image5= strcat('<p><img src="http://s30.postimg.org/j62flobmp/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image6= strcat('<p><img src="http://s30.postimg.org/srw01z2sh/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');

numString1 = cloze_mcq('vertical', 1, image3, 'Good Job!', image4, 'Incorrect',image5, 'Incorrect', image6,'Incorrect');
...
questionString = strcat('<p>The image below shows the Voigt Model for viscoelastic materials, along with the displacement time plot obtained when a fixed load (F) is',...
    ...
    '<br><p><br></p><p>From the options below, select which graph correctly represents what would happen if the spring constant of the spring was doubled, but the dashpot unchanged (represented by the blue line).</p>',...
...
generalFeedbackStr = strcat('<p>The image above shows the correct answer to this question.</p>',...
    ...
    '<p>The slope will asymptotically move towards this new value of (F/k).</p>',...
    '<p>The initial gradient of the slope represents the rate of displacement of the system, and is defined by (F/$$\\small\\eta$$). As $$\\small\\eta$$ remains unchanged, so too does the initial gradient of the slope.</p>');
