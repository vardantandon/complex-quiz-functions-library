...
IDString=strcat('Voigt-3. Question ID #', ID);
...
plot(t,u3,'linewidth',3,'Color','[1    0.5  1 ]');
plot(t1,u4,'linewidth',3,'Color','[1    0.5  1 ]','Linestyle',':');
plot(t2,u5,'linewidth',3,'Color','[1    0.5  1 ]');
...
image3= strcat('<p><img src="http://s24.postimg.org/ts3uj8nzp/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image4= strcat('<p><img src="http://s24.postimg.org/9ok876vzp/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image5= strcat('<p><img src="http://s24.postimg.org/i49sooyut/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');
image6= strcat('<p><img src="http://s24.postimg.org/pyaea36np/image.jpg" alt="" width="560" height="420" role="presentation" style="vertical-align:middle; margin: 0 .5em;" class="img-responsive"><br></p>');

numString1 = cloze_mcq('vertical', 3, image3, 'Incorrect', image4, 'Incorrect',image5, 'Good Job!', image6,'Incorrect');
...
questionString = strcat('<p>The image below shows the Voigt Model for viscoelastic materials, along with the displacement time plot obtained when a fixed load (F) is',...
    ...
    '<br><p><br></p><p>From the options below, select which graph correctly represents what would happen if the spring constant of the spring was doubled, AND the viscosity in the dashpot was halved (represented by the pink line).</p>',...
...
generalFeedbackStr = strcat('<p>The image above shows the correct answer to this question.</p>',...
    '<p>There are two issues to consider when answering this question:</p>',...
    ...
    '<p>The slope will asymptotically move towards this new smaller value of (F/k).</p>',...
    '<p>2. The initial gradient of the slope represents the rate of displacement of the system, and is defined by (F/$$\\small\\eta$$). As $$\\small\\eta$$ has been halved, the initial gradient of the slope has doubled.</p>');

hint1 = strcat('<p>Which aspects of the graph will be affected by the change in the spring constant?</p>');
