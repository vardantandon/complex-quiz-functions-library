...
arrow([P5,0.4],[P5,0.1],'LineWidth',2); %plots a point load at the start of the ist distributed load

U4_label=strcat(num2str(U4),'N');

text(P5-Le/30,0.5,U4_label,'fontsize',14,'fontweight','bold');
...
arrow([P3,-0.1],[P3,-0.4],'LineWidth',2); %plots a point load at the start of the ist distributed load
