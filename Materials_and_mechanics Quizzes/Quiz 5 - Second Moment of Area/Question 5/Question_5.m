...
IDString=strcat('Second Moment of Area. Level 5.Question ID #', ID);   
...
rectangle('Position',[c+4*d,e,d,d],'Curvature',[1,1],'LineWidth',1.5,'FaceColor','y');
text (c+0.1, e-d ,'Level 5','FontWeight', 'bold', 'fontsize',15)
