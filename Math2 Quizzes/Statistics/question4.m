...
for i=1:1:100
    ...
    feedbackString = strcat( ...
        ...
        '$$ = \\large \\frac{1}{2N + 1} + \\frac{2}{2N+1}\\frac{e^{-2T}(1-e^{-2NT})}{1-e^{-2T}} - \\frac{1}{(2N + 1)^2}$$<br>', ...
        ...
        '$$ = \\lim_{N \\to \\infty} [\\frac{1}{2N + 1} + \\frac{2}{2N+1}\\frac{e^{-2T}(1-e^{-2NT})}{1-e^{-2T}} - \\frac{1}{(2N + 1)^2}] = 0 $$<br><br>', ...
        '<p style="font-size: 0px">$$</p>' ... This causes the latex to be non/image, hence much clearer
    );
