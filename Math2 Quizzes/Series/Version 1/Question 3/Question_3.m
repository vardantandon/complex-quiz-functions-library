...
feedbackString = strcat('The error for $$\\small \\theta$$ is given by : <br>','$$\\small \\frac{sin(\\theta) - \\theta}{sin(\\theta)}$$ x 100%%<br>',...
                         'Using a calculator, the error is found to be&nbsp;',num2str(a),'%% at&nbsp;','$$\\small \\theta$$&nbsp;$$\\small \\approx$$&nbsp;',num2str(radAngle),' radians or',...
