...
if (flag == 1 || flag ==3)
 ...
 'First term : a<sub>1</sub> =','',' a<sub>2</sub> ','','[At n=0 , the first term for both the series will be to the power 0 which equals 1]<br>Common ratios : r<sub>1</sub> =&nbsp;$$\\small \\frac{1}{', num2str(a),'}$$ , ',...
