...
for i=1:1:100
    ...
    feedbackString = strcat('The width of the Fourier spectrum is approximately equal to the reciprocal of the pulse duration, i.e. about 1/', num2str(duration), '&nbsp;=&nbsp;', num2str(round(frequency,2)), '&nbsp;Hz.');
