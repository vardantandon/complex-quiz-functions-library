...
file=fopen('question5_level1.xml','w'); 
...
for i=1:1:100
    ...
    questionString = ['Level 1 <br><br>Use Laplace transforms to solve the following differential equation given that y = ' num2str(h) ' at t = 0:' ...
        '<br><br><p style="text-align: center;">$$ \small ' num2str(a) '\frac{dy}{dt} + ' num2str(b) 'y = 0 $$ </p>' ...
    ...
    step1 = [num2str(a) ' [sY(s) - y(0)] + ' num2str(b) '[Y(s)] = 0'];
    step2 = [num2str(a) ' [sY(s) - ' num2str(h) '] + ' num2str(b) '[Y(s)] = 0'];
    step3 = [' Y(s) = ' latex(f)];
    ...
    feedbackString = strcat(feedbackString, 'Step 3: From an expression for <b>Y(s)</b>:<br>');
    ...
    fprintf(file,'\n    <name>');
    fprintf(file,'\n      <text>Level 1 - Differential Equations using Laplace Transforms</text>');
    fprintf(file,'\n    </name>');
