...
ibeam3=fopen('ibeam3.xml','w');

fprintf(ibeam3,'%s','<?xml version="1.0" encoding="UTF-8"?>');
fprintf(ibeam3,'\n%s','<quiz>');
...
rectangle('Position',[W+2,L+15,2,3],'Curvature',[1,1],'LineWidth',1.5);

hold off

beami=strcat('ibeam3_',num2str(i),'.jpg');
saveas(m,beami);
...
fprintf(ibeam3,'\n%s','<name>');
fprintf(ibeam3,'\n<text>I-beam %d (Level 3)</text>',i);
fprintf(ibeam3,'\n%s','</name>');

fprintf(ibeam3,'\n%s','<questiontext format="html">');
fprintf(ibeam3,'\n%s','<text>');
fprintf(ibeam3,'%s','<![CDATA[<p><img style="margin-right: auto; margin-left: auto; display: block;"');
fprintf(ibeam3,' src="http://www.ucl.ac.uk/~wmapsfl/moodle/I-beam/Ibeam_3/ibeam3_%d.jpg" alt="Beamplot" width="561" height="420"/></p>',i);
fprintf(ibeam3,'\n%s','<p style="text-align: center;">Given an I-beam with dimensions as indicated in the image above,');
fprintf(ibeam3,'%s',' find the x and y coordinates of the centroid, to 1 d.p., in mm.</p>');
fprintf(ibeam3,'\n%s','<p style="text-align: center;">Centroid = ');
fprintf(ibeam3,'({1:NUMERICAL:=%6.1f#Excellent!~*#I''m sorry}  ,  {1:NUMERICAL:=%6.1f#Excellent!~*#I''m sorry})  mm </p>',x_cm,y_cm);
...
fprintf(ibeam3,'{2:NUMERICAL:=%3.0f:%1.0f#Excellent!~*#I''m sorry} mm<sup>4</sup></p>',Ix,E_Ix);
fprintf(ibeam3,'\n%s','<p style="text-align: center;">I<sub>y</sub> = ');
fprintf(ibeam3,'{2:NUMERICAL:=%3.0f:%1.0f#Excellent!~*#I''m sorry} mm<sup>4</sup></p>]]>',Iy,E_Iy);
fprintf(ibeam3,'%s','</text>');

fprintf(ibeam3,'\n%s','</questiontext>');

fprintf(ibeam3,'\n%s','<generalfeedback format="html">');
fprintf(ibeam3,'\n%s','<text><![CDATA[');
fprintf(ibeam3,'%s','<p>In order to calculate the moments of inertia, it may be useful to split the area into different segments, in order to simplify the problem.</p>');
fprintf(ibeam3,'%s',']]></text>');
fprintf(ibeam3,'\n%s','</generalfeedback>');
