...
BMA=-M;
BMB=-(abs(M-R*E1_in_m));
%BMC=-abs(M-(R*E2_in_m)-(W*(Length_Load/100)/2));
BMC=-abs(W2*(L_in_m-E2_in_m-Length_Load/200));
BMD=-abs(W2*(Length_Load_2/100)/2);
BME=0;
BMF=0;
