...
SF=plot([0,0],[0,SFA],'linewidth',3,'Color','red');

hold on

plot([0,P_in_m],[SFA,SFA],'linewidth',3,'Color','red');
...
shearforce=strcat('shearforce_level2','.jpg');
...
bendingmoment=strcat('bendingmoment_level2','.jpg');
