...
imgname=strcat('Images/level5a_',num2str(i),'.jpg');
...
imgname=strcat('Images/level5b_',num2str(i),'.jpg');
...
fprintf(comb5,'src="http://www.ucl.ac.uk/~rmapdpg/MoodleQuiz/SimplySupported/Level_5/level5a_%d.jpg"',i);  %Change the URL of the images
...
fprintf(comb5,'src="http://www.ucl.ac.uk/~rmapdpg/MoodleQuiz/SimplySupported/Level_5/level5b_%d.jpg"',i);
fprintf(comb5,'%s','alt="Beamplot" width="30 height="30"/></p>');
...
%-----------------------------------
%Note that the correct answer is indicated by symbol '~=' while the wrong
