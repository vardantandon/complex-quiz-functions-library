...
fprintf(circ1,'src="http://www.ucl.ac.uk/~rmapdpg/MoodleQuiz/Centroid/Level_1/CentroidL1_%d.jpg"',i);
...
fprintf(circ1,'\n%s','<![CDATA[<p>The centroid is the central point of the circle and ');
