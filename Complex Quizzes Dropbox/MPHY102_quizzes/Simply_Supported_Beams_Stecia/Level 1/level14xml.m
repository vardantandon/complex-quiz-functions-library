...
fprintf(comb1,'\n%s','<p style="text-align: left;">There is an external point force acting on the beam as shown in the diagram.</p>');
...
fprintf(comb1,'R1 = {1:NUMERICAL:=%3.0f:1#Good job!~*#Sorry. Try again.} N</p>',R1);
fprintf(comb1,'\n%s','<p style="text-align: center;" >');
fprintf(comb1,'R2 = {1:NUMERICAL:=%3.0f:1#Good job!~*#Sorry. Try again.} N</p>',R2);
...
fprintf(comb1,'\n%s','<p style="text-align: left;">Shear Force just to the right of C i.e (x=L).</p>');
fprintf(comb1,'\n%s','<p style="text-align: center;">');
fprintf(comb1,'{1:NUMERICAL:=%3.0f:1#Good job!~*#Sorry. Try again.} N</p>',0);
...
fprintf(comb1,'\n%s','<p style="text-align: center;">');
fprintf(comb1,'{1:NUMERICAL:=%3.0f:1#Good job!~*#Sorry. Try again.} N.m</p>',0);

fprintf(comb1,'\n%s','<p style="text-align: left;">Bending Moment at B.</p>');
fprintf(comb1,'\n%s','<p style="text-align: center;">');
fprintf(comb1,'{1:NUMERICAL:=%3.0f:1#Good job!~*#Sorry. Try again.} N.m</p>',B);
