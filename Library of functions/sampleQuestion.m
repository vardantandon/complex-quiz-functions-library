...
for i=1:1:1
    ...
    questionString = strcat(num2str(a), ' +&nbsp;', num2str(b), ' = <br>', ...
        '<img src="@@PLUGINFILE@@/image.png" style="width:100%%; height:auto;"><br>', ...
        '<br><Br>Dropdown box', mcqStringDrop, ...
        '<br><br>Vertical MCQs', mcqStringVertical, ...
        '<br><br>Horizontal MCQs', mcqStringHorizontal, ...
        '<br><br>Numerical Box <br>', numString, ...
        '<br><br>Capital of France? <br>', shortString, ...
        '<br><br>Matrix C<br><br>', matrixString);
